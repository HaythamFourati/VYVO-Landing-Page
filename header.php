  ...
  <body <?php body_class(); ?>>
    ...
    <div class="max-w-7xl container mx-auto flex items-center justify-between py-4 px-4">
        ...
        <nav class="hidden md:flex items-center space-x-8">
            <a href="#features" class="transition-colors duration-300 hover:text-purple-400 scroll-smooth">Features</a>
            <a href="#technology" class="transition-colors duration-300 hover:text-purple-400 scroll-smooth">Technology</a>
            <a href="#about" class="transition-colors duration-300 hover:text-purple-400 scroll-smooth">About</a>
            <a href="#contact" class="transition-colors duration-300 hover:text-purple-400 scroll-smooth">Contact</a>
        </nav>
        <div>
